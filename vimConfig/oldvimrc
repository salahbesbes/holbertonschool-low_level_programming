...
"    nmap <buffer> mp <plug>(lsp-definition)
"    nmap <buffer> mo <plug>(lsp-references)
"    nmap <buffer> mi <plug>(lsp-implementation)
"    nmap <buffer> mu <plug>(lsp-type-definition)
"    nmap <buffer> <leader>r <plug>(lsp-rename)
"    nmap <buffer> mt <Plug>(lsp-previous-diagnostic)
"    nmap <buffer> mr <Plug>(lsp-next-diagnostic)
"    nmap <buffer> me <plug>(lsp-hover)  
